...
export default function CustomerDashboard() {
  ...
  return (
    <div style={{ fontFamily: "'Poppins', sans-serif", backgroundColor: '#040404', color: '#f6f1e4', minHeight: '100vh' }}>
      ...
      <header className="sticky-top border-bottom" style={{ backgroundColor: '#0F0F0F', borderColor: 'rgba(212, 175, 55, 0.25)', height: 70 }}>
        <div className="container-fluid px-4 h-100 d-flex align-items-center justify-content-between">
          <div className="d-flex align-items-center gap-3">
            <button onClick={() => setSidebarOpen(!sidebarOpen)} className="btn btn-sm d-md-none text-white border-0">
              <Menu size={22} />
            </button>
            <div className="d-flex align-items-center gap-2 cursor-pointer" onClick={() => navigate('/')}>
              ...
              <span className="fs-5 font-bold tracking-widest font-serif gold-gradient-text">AUREUM</span>
            </div>
          </div>

          <div className="d-flex align-items-center gap-3">
            {/* Cart Counter */}
            <button onClick={() => setActiveTab('cart')} className="btn btn-sm text-white position-relative border-0">
      ...
      {cartNotification && (
        <div className="position-fixed top-0 start-50 translate-middle-x mt-5" style={{ zIndex: 1080 }}>
          <div className="alert alert-success bg-dark border-warning text-warning py-2 px-4 rounded-pill shadow-lg">
            {cartNotification}
          </div>
        </div>
      )}
      ...
      <div className="d-flex">
        ...
        {/* SIDEBAR */}
          ...
          <div className="px-2 pb-3 text-uppercase fs-8 font-semibold tracking-wider" style={{ color: GOLD_LIGHT }}>
            Customer Workspace
          </div>
          <nav className="d-flex flex-column gap-1">
            {sidebarMenuItems.map((item) => {
              ...
              const itemTextColor = isActive || highlightItem ? GOLD_LIGHT : '#a99f80';
              const itemIconColor = isActive || highlightItem ? GOLD : '#8a7a4d';
              return (
                <button
                  key={item.id}
        ...
        <main className="flex-grow-1 p-4 overflow-y-auto" style={{ minWidth: 0 }}>
          ...
          <div className="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 mb-4 p-4 rounded-4 border" style={{ backgroundColor: '#090806', borderColor: 'rgba(212,175,55,0.25)' }}>
            <div>
              <div className="d-flex align-items-center gap-2 mb-1">
                ...
                <h1 className="fs-4 font-bold mb-0 gold-gradient-text">Welcome Back, </h1>
              </div>
              <p className="fs-8 mb-0" style={{ color: GOLD_LIGHT }}>Browse luxury items, track your order shipments, and claim rewards.</p>
            </div>
            <div className="d-flex align-items-center gap-2">
              <div className="input-group" style={{ maxWidth: 280 }}>
                <span className="input-group-text bg-dark border-secondary text-muted"><Search size={14} /></span>
                <input value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} placeholder="Search catalog..." className="form-control form-control-sm bg-dark text-white border-secondary fs-8" />
              </div>
            </div>
          </div>
            ...
            <div className="d-flex flex-column gap-4">
              ...
              <div className="row g-3">
                <div className="col-6 col-md-4 col-lg-2.4">
                  <div className="gold-stat-card">
                    <div className="fs-8 text-muted mb-1">Total Orders</div>
                    <div className="fs-4 font-bold text-white">{orders.length}</div>
                    <div className="fs-8 text-success font-semibold mt-1">Active Account</div>
                  </div>
                </div>
                <div className="col-6 col-md-4 col-lg-2.4">
                  <div className="gold-stat-card">
                    <div className="fs-8 text-muted mb-1">In Transit</div>
                    <div className="fs-4 font-bold text-white">{orders.filter(o => o.status === 'Shipped' || o.status === 'Pending').length}</div>
                    <div className="fs-8 text-warning font-semibold mt-1">On the way</div>
                  </div>
                </div>
                <div className="col-6 col-md-4 col-lg-2.4">
                  <div className="gold-stat-card">
                    <div className="fs-8 text-muted mb-1">Completed</div>
                    <div className="fs-4 font-bold text-gold">{orders.filter(o => o.status === 'Completed' || o.status === 'Delivered').length}</div>
                    <div className="fs-8 text-success font-semibold mt-1">Delivered</div>
                  </div>
                </div>
                <div className="col-6 col-md-4 col-lg-2.4">
                  <div className="gold-stat-card">
                    <div className="fs-8 text-muted mb-1">Cart Items</div>
                    <div className="fs-4 font-bold text-white">{cartItems.length}</div>
                    <div className="fs-8 text-warning font-semibold mt-1">In Cart</div>
                  </div>
                </div>
                <div className="col-6 col-md-4 col-lg-2.4">
                  <div className="gold-stat-card">
                    <div className="fs-8 text-muted mb-1">Saved Wishlist</div>
                    <div className="fs-4 font-bold text-white">{wishlistItems.length}</div>
              ...
              <div className="row g-3">
                <div className="col-12 col-lg-8">
                  <div className="gold-panel">
                    <h3 className="fs-6 font-bold text-white mb-1">Shopping Spend Analytics</h3>
                    <p className="fs-8 text-muted mb-3">Monthly expenditure on AUREUM platform stores</p>
                ...
                <div className="col-12 col-lg-4">
                  <div className="gold-panel d-flex flex-column justify-between">
                    <div>
                      <div className="d-flex align-items-center gap-2 mb-2 text-warning">
                        <Award size={20} />
                        <h3 className="fs-6 font-bold text-white mb-0">AUREUM Club Rewards</h3>
                      </div>
                      <div className="fs-3 font-bold text-white mb-1">1,250 <span className="fs-8 font-normal text-muted">Pts</span></div>
                      <p className="fs-8 text-muted mb-3">You are 250 points away from unlocking <strong>Platinum Tier</strong> benefits & free international shipping.</p>
                      <div className="progress bg-dark mb-2" style={{ height: 8 }}>
              ...
              <div className="gold-panel">
                <div className="d-flex align-items-center justify-content-between mb-3">
                  <h3 className="fs-6 font-bold text-white mb-0">Recent Shipments & Orders</h3>
                      ...
                      {orders.map((o) => (
                        <tr key={o.id}>
                          ...
                          <td className="text-white">
                            ...
                            <div className="fs-8 text-muted">{o.itemSummary || 'Awaiting item details'}</div>
                          </td>
                          <td className="fs-8 text-muted">{o.created_at}</td>
                          <td className="fw-bold text-white">${o.total_amount}</td>
                          <td>
              ...
              <div className="d-flex flex-column gap-4">
                ...
                <div className="p-4 rounded-3xl border" style={{ background: '#0b0a08', borderColor: 'rgba(212,175,55,0.2)' }}>
                  ...
                  <div className="mb-4 d-flex flex-wrap align-items-center gap-2">
                    ...
                    <span className="badge bg-dark border border-secondary text-white py-2 px-3 fs-8">
                  ...
                  {selectedStoreProducts.length > 0 ? (
                    <div className="mb-4">
                      <h3 className="fs-5 text-white mb-3">Store Products</h3>
                      <div className="row g-3">
                            ...
                            <div className="gold-panel p-3 h-100 d-flex flex-column justify-between">
                              <div>
                                ...
                                <div className="d-flex align-items-center justify-content-between mb-2">
                                  ...
                                  <span className="fs-8 text-muted">{product.stock_quantity ?? 0} left</span>
                                </div>
                                <h4 className="fs-6 font-bold text-white mb-1">{product.name}</h4>
                                <p className="fs-8 text-muted mb-3 line-clamp-2">{product.description || 'High-quality store item available for immediate purchase.'}</p>
                              </div>
                              <div className="d-flex gap-2 align-items-center justify-content-between">
                                ...
                                <button
                                  ...
                                  className={`btn btn-sm py-2 px-3 d-flex align-items-center justify-content-center ${wishlistItems.some((item) => item.id === product.id) ? 'btn-danger text-white' : 'btn-outline-warning text-white'}`}
                                  title="Add to Wishlist"
                                >
                                  <Heart size={14} className={`${wishlistItems.some((item) => item.id === product.id) ? 'text-white' : 'text-warning'}`} />
                                </button>
                              </div>
                            </div>
                          </div>
                    ...
                    <div className="gold-panel p-3 mb-4 text-center">
                      <p className="fs-8 text-muted mb-0">No products available for this store yet.</p>
                    </div>
                  )}
          ...
          {activeTab === 'products' && (
            <div className="d-flex flex-column gap-3">
              <div className="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
                <div>
                  <h2 className="fs-4 font-bold text-white mb-0">Store Products Catalog</h2>
                  <p className="fs-8 text-muted mb-0">Browse items available across registered Aureum platform stores</p>
                </div>
                <div className="d-flex flex-wrap align-items-center gap-2">
                  <div className="d-flex align-items-center gap-1 bg-dark px-2 py-1 rounded border border-secondary">
                    <Store size={14} className="text-warning" />
                    <select
                      value={selectedStoreFilter}
                      onChange={(e) => setSelectedStoreFilter(e.target.value)}
                      className="form-select form-select-sm bg-dark text-white border-0 fs-8 py-0 shadow-none"
                  ...
                  <div className="d-flex gap-1 overflow-x-auto py-1">
                    {categories.map((c) => (
                      <button
                        ...
                        className={`btn btn-sm px-3 py-1 rounded-pill fs-8 text-nowrap ${selectedCategory === c ? 'btn-warning text-dark font-bold' : 'btn-outline-secondary text-white'}`}
                      >
                        {c}
                      </button>
                    ))}
              ...
              {filteredProducts.length === 0 ? (
                <div className="gold-panel text-center py-5">
                  ...
                  <h3 className="fs-6 text-white mb-1">No products found</h3>
                  <p className="fs-8 text-muted">Try clearing your store or category search filter.</p>
                </div>
              ) : (
                <div className="row g-3">
                  {filteredProducts.map((p) => (
                    <div key={p.id} className="col-12 col-sm-6 col-md-4 col-lg-3">
                      <div className="gold-panel p-3 d-flex flex-column justify-between h-100 position-relative group">
                        <div className="position-relative mb-2 cursor-pointer" onClick={() => setShowQuickViewProduct(p)}>
                          ...
                          <button
                            ...
                            className={`position-absolute top-0 end-0 m-2 p-1.5 rounded-circle border ${wishlistItems.some((item) => item.id === p.id) ? 'bg-danger border-danger text-white' : 'bg-dark border-secondary text-white'}`}
                            title="Add to Wishlist"
                          >
                            <Heart size={14} className={wishlistItems.some((item) => item.id === p.id) ? 'text-white' : 'text-warning'} />
                          </button>
                        </div>
                        <div>
                          <div className="d-flex align-items-center justify-content-between mb-1">
                            <span className="fs-8 text-warning font-semibold">{cleanCategoryLabel(p.category)}</span>
                            <span className="fs-8 text-muted d-flex align-items-center"><Star size={11} className="text-warning fill-warning me-1" />{p.rating || 4.9}</span>
                          </div>
                          <div
                            onClick={() => setShowQuickViewProduct(p)}
                            className="fs-7 font-bold text-white mb-2 line-clamp-1 cursor-pointer hover:text-warning transition-all"
                            title="Click to view store product details"
                          >
                            {p.name}
                          </div>
                          <div className="fs-6 font-bold text-white mb-3">${p.price}</div>
                        </div>
            ...
            <div className="d-flex flex-column gap-4">
              <div className="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
                <div>
                  ...
                  <h2 className="fs-4 font-bold text-white mb-0">Store Product Categories</h2>
                  <p className="fs-8 text-muted mb-0">Categories created and maintained by store owners across all verified shops</p>
                </div>
                ...
                <div className="input-group" style={{ maxWidth: 280 }}>
                  ...
                  <input
                    ...
                    className="form-control form-control-sm bg-dark text-white border-secondary fs-8"
                  />
                </div>
              </div>
              ...
              <div className="row g-3">
                {categoriesList.filter(c => 
                  ...
                  <div key={cat.id} className="col-12 col-md-6 col-lg-4">
                    <div className="gold-panel p-4 d-flex flex-column justify-between h-100">
                      <div>
                        <div className="d-flex align-items-center justify-content-between mb-3">
                          <div className="d-flex align-items-center gap-2">
                            ...
                            <div>
                              <h3 className="fs-6 font-bold text-white mb-0">{cat.name}</h3>
                          ...
                          {cat.featured ? (
                            ...
                            <span className="badge bg-dark border border-secondary text-muted fs-8">Standard</span>
                          )}
                        </div>

                        <p className="fs-8 text-muted mb-3" style={{ lineHeight: 1.5 }}>
                      ...
                      <div className="d-flex align-items-center justify-content-between pt-3 border-top" style={{ borderColor: "rgba(212,175,55,0.15)" }}>
                        <span className="badge bg-secondary bg-opacity-50 text-white font-mono px-2 py-1 fs-8">
          ...
          {activeTab === 'wishlist' && (
            <div className="d-flex flex-column gap-3">
              <h2 className="fs-4 font-bold text-white mb-0">My Wishlist</h2>
              {wishlistItems.length === 0 ? (
                <div className="gold-panel text-center py-5">
                  <Heart size={40} className="text-muted mb-2" />
                  <h3 className="fs-6 text-white">Your wishlist is empty</h3>
                </div>
              ) : (
                <div className="row g-3">
                  {wishlistItems.map((item) => (
                    <div key={item.id} className="col-12 col-md-4">
                      <div className="gold-panel p-3 d-flex gap-3 align-items-center">
                        <img
                        ...
                        <div className="flex-grow-1">
                          <div className="fs-7 font-bold text-white">{item.name}</div>
          ...
          {activeTab === 'cart' && (
            <div className="d-flex flex-column gap-3">
              <h2 className="fs-4 font-bold text-white mb-0">Your Shopping Cart</h2>
              {cartItems.length === 0 ? (
                <div className="gold-panel text-center py-5">
                  <ShoppingCart size={40} className="text-muted mb-2" />
                  <h3 className="fs-6 text-white">Your cart is currently empty</h3>
                </div>
              ) : (
                <div className="row g-3">
                  <div className="col-12 col-lg-8">
                                ...
                                <tr key={idx}>
                                  <td>
                                    <div className="d-flex align-items-center gap-3">
                                      ...
                                      <div>
                                        <div className="fw-bold text-white">{productName}</div>
                                        <div className="fs-8 text-muted">{item.product?.store_name || item.store_name || 'AUREUM Store'}</div>
                                      </div>
                                    </div>
                                  </td>
                                  <td className="text-end">{quantity}</td>
                                  <td className="text-end text-warning">${unitPrice.toFixed(2)}</td>
                                  <td className="text-end text-white">${rowTotal}</td>
                                  <td className="text-end">
                  ...
                  <div className="col-12 col-lg-4">
                    <div className="gold-panel p-4">
                      <h3 className="fs-6 font-bold text-white mb-3">Order Summary</h3>
                      <div className="d-flex justify-content-between fs-7 mb-2"><span className="text-muted">Items ({totalCartCount})</span> <span>${cartSubtotal.toFixed(2)}</span></div>
                      <div className="d-flex justify-content-between fs-7 mb-2"><span className="text-muted">Shipping</span> <span className="text-success">FREE</span></div>
                      <div className="d-flex justify-content-between fs-7 mb-2"><span className="text-muted">Taxes</span> <span>${(cartSubtotal * 0.00).toFixed(2)}</span></div>
          ...
          {activeTab === 'payment' && (
            <div className="d-flex flex-column gap-3">
              <h2 className="fs-4 font-bold text-white mb-0">Payment Checkout</h2>
              <div className="row g-3">
                <div className="col-12 col-lg-7">
                  <div className="gold-panel p-4">
                    <div className="d-flex align-items-center gap-3 mb-4">
                      ...
                      <div>
                        <div className="fs-6 font-bold text-white">Cash on Delivery</div>
                        <div className="fs-8 text-muted">Pay with cash when your order arrives.</div>
                      </div>
                    </div>
                    ...
                    {!paymentConfirmed ? (
                      <form className="d-flex flex-column gap-3" onSubmit={(e) => { e.preventDefault(); handleConfirmPayment(); }}>
                        <div className="p-3 mb-2 rounded-3" style={{ background: 'rgba(212,175,55,0.05)', border: '1px solid rgba(212,175,55,0.2)' }}>
                          <p className="fs-8 text-white mb-0">You have selected Cash on Delivery. Please keep the exact change ready at the time of delivery.</p>
                        </div>
                      ...
                      <div className="text-center py-5">
                        ...
                        <h3 className="fs-5 font-bold text-white mb-2">Order Confirmed</h3>
                        <p className="fs-8 text-muted mb-3">Your order of <strong>${paymentAmount.toFixed(2)}</strong> has been successfully placed.</p>
                ...
                <div className="col-12 col-lg-5">
                  <div className="gold-panel p-4">
                    <h3 className="fs-6 font-bold text-white mb-3">Order Summary</h3>
                    <div className="d-flex justify-content-between fs-7 mb-2"><span className="text-muted">Subtotal</span> <span>${paymentAmount.toFixed(2)}</span></div>
                    <div className="d-flex justify-content-between fs-7 mb-2"><span className="text-muted">COD Fee</span> <span>$0.00</span></div>
                    <div className="d-flex justify-content-between fs-7 mb-3"><span className="text-muted">Shipping</span> <span className="text-success">FREE</span></div>
                    ...
                    <div className="mt-4 p-3 rounded-3" style={{ background: '#0f0d0b', border: '1px solid rgba(212,175,55,0.12)' }}>
                      ...
                      <div className="fs-8 text-muted">A fast and secure way to pay upon arrival.</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {activeTab === 'orders' && (
            <div className="d-flex flex-column gap-3">
              <h2 className="fs-4 font-bold text-white mb-0">My Order History</h2>
              <div className="gold-panel">
                <div className="table-responsive">
                  <table className="table table-dark table-hover mb-0 align-middle">
                    <thead>
                      ...
                      {orders.length === 0 ? (
                        ...
                        <tr key={o.id}>
                          ...
                          <td className="text-white">
                            ...
                            <div className="fs-8 text-muted">{o.itemSummary || 'No items listed'}</div>
                          </td>
                          <td className="fs-8 text-muted">{o.carrier || 'FedEx'}</td>
          ...
          {activeTab === 'addresses' && (
            <div className="d-flex flex-column gap-3">
              <div className="d-flex align-items-center justify-content-between">
                <h2 className="fs-4 font-bold text-white mb-0">Saved Addresses</h2>
              ...
              <div className="row g-3">
                {addresses.map((addr) => (
                  <div key={addr.id} className="col-12 col-md-6">
                    <div className="gold-panel p-3">
                      <div className="d-flex justify-content-between align-items-center mb-2">
                        <span className="gold-badge-amber">{addr.type}</span>
                        {addr.isDefault && <span className="gold-badge-emerald">Default</span>}
                      </div>
                      <div className="fw-bold text-white mb-1">{addr.label || addr.type}</div>
                      <p className="fs-8 text-muted mb-2">{addr.address}</p>
                      <div className="fs-8 text-muted mb-3">Phone: {addr.phone}</div>
          ...
          {activeTab === 'coupons' && (
            <div className="d-flex flex-column gap-3">
              <h2 className="fs-4 font-bold text-white mb-0">Coupons & Rewards</h2>
              <div className="row g-3">
                {[
                  ...
                  <div key={i} className="col-12 col-md-6">
                    <div className="gold-panel p-3 border-dashed">
                      ...
                      <p className="fs-8 text-muted mb-1">{c.desc}</p>
                      <div className="fs-9 text-muted">{c.expiry}</div>
                    </div>
                  </div>
                ))}
              </div>
          ...
          {(activeTab === 'settings' || activeTab === 'profile' || activeTab === 'support') && (
            <div className="d-flex flex-column gap-3">
              <h2 className="fs-4 font-bold text-white mb-0">Account Profile & Settings</h2>
              {savedNotification && <div className="alert alert-success bg-dark text-success border-success fs-7">Profile updated successfully!</div>}
              <div className="gold-panel col-12 col-md-6">
                <form onSubmit={handleProfileSubmit} className="d-flex flex-column gap-3 fs-7">
                  <div>
                    <label className="text-muted mb-1 fs-8">Full Name</label>
                    <input value={profileData.name} onChange={(e) => setProfileData({ ...profileData, name: e.target.value })} className="form-control" />
                  </div>
                  <div>
                    <label className="text-muted mb-1 fs-8">Email Address</label>
                    <input value={profileData.email} onChange={(e) => setProfileData({ ...profileData, email: e.target.value })} className="form-control" />
                  </div>
                  <div>
                    <label className="text-muted mb-1 fs-8">Phone Number</label>
            ...
            <div className="d-flex flex-column gap-4">
              <div className="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
                <div>
                  ...
                  <h2 className="fs-4 font-bold text-white mb-0">Explore Merchant Stores</h2>
                  <p className="fs-8 text-muted mb-0">Browse all verified merchant stores operating on the Aureum platform</p>
                </div>
                    ...
                    <div className="gold-panel p-4 d-flex flex-column justify-between h-100">
                      <div>
                        <div className="d-flex align-items-start justify-content-between gap-3 mb-3">
                          <div className="d-flex align-items-center gap-3">
                            ...
                            <div>
                              <h3 className="fs-5 font-bold text-white mb-0">{s.name}</h3>
                        ...
                        <div className="row g-2 p-2 rounded-3 mb-3" style={{ background: "#0e0d0b", border: "1px solid rgba(212,175,55,0.15)" }}>
                          <div className="col-6">
                            <span className="fs-8 text-muted d-block">Category</span>
                            <span className="fs-8 fw-semibold text-white">{s.category}</span>
                          </div>
                          <div className="col-6">
                            <span className="fs-8 text-muted d-block">Merchant Owner</span>
                      ...
                      <div className="d-flex align-items-center justify-content-between pt-2 border-top" style={{ borderColor: "rgba(212,175,55,0.15)" }}>
                        <div className="d-flex align-items-center gap-1 fs-8 text-muted">
                          ...
                          <strong className="text-white">{s.rating || 4.9}</strong> ({s.products_count || 18} Products)
                        </div>
                        <div className="d-flex gap-2">
                          <button
                            onClick={() => {
        ...
        <div className="position-fixed top-0 bottom-0 start-0 end-0 bg-dark bg-opacity-75 d-flex align-items-center justify-content-center p-3" style={{ zIndex: 1050 }}>
          <div className="gold-panel w-100" style={{ maxWidth: 500 }}>
            <div className="d-flex align-items-center justify-content-between mb-3 border-bottom pb-2" style={{ borderColor: 'rgba(212,175,55,0.2)' }}>
              ...
              <button onClick={() => { setShowTrackingModalOrder(null); setSelectedOrderDetails(null); setOrderDetailsError(''); }} className="btn btn-sm text-muted p-0">✕</button>
            </div>

            {orderDetailsLoading ? (
              <div className="py-5 text-center text-muted">Loading order details…</div>
            ) : (
              <>
                ...
                <div className="d-flex flex-column gap-3 mb-3 fs-8">
                  <div className="d-flex justify-between"><span className="text-muted">Store:</span> <strong>{selectedOrderDetails?.store_name || showTrackingModalOrder.store_name || 'Unknown Store'}</strong></div>
                  <div className="d-flex justify-between"><span className="text-muted">Carrier:</span> <strong>{selectedOrderDetails?.carrier || showTrackingModalOrder.carrier || 'FedEx Express'}</strong></div>
                  <div className="d-flex justify-between"><span className="text-muted">Tracking Code:</span> <span className="font-mono text-warning">{selectedOrderDetails?.tracking || showTrackingModalOrder.tracking || 'TRK-982401'}</span></div>
                  <div className="d-flex justify-between"><span className="text-muted">Status:</span> <span className="gold-badge-emerald">{selectedOrderDetails?.status || showTrackingModalOrder.status || 'Pending'}</span></div>
                  <div className="d-flex justify-between"><span className="text-muted">Total Paid:</span> <strong>${(selectedOrderDetails?.total_amount ?? showTrackingModalOrder.total_amount ?? 0).toFixed(2)}</strong></div>
                </div>

                <div className="p-3 bg-dark rounded border border-secondary mb-3">
                  <div className="fs-8 text-muted mb-2">Order Summary</div>
                  <div className="d-flex justify-between"><span className="text-muted">Items count</span> <strong>{selectedOrderDetails?.items_count ?? showTrackingModalOrder.items_count ?? 'N/A'}</strong></div>
                  <div className="d-flex justify-between"><span className="text-muted">Placed on</span> <strong>{selectedOrderDetails?.created_at || showTrackingModalOrder.created_at || 'N/A'}</strong></div>
                  <div className="d-flex justify-between"><span className="text-muted">Customer Email</span> <strong>{selectedOrderDetails?.customer_email || showTrackingModalOrder.customer_email || 'N/A'}</strong></div>
                  <div className="d-flex justify-between"><span className="text-muted">Payment</span> <strong>{selectedOrderDetails?.payment_status || showTrackingModalOrder.payment_status || 'Completed'}</strong></div>
                  {(selectedOrderDetails?.itemsList || showTrackingModalOrder.itemsList || []).length > 0 && (
                    <div className="mt-3">
                      <div className="fs-8 text-muted mb-2">Ordered Products</div>
                      <div className="d-flex flex-column gap-2">
                        {(selectedOrderDetails?.itemsList || showTrackingModalOrder.itemsList || []).map((item, index) => (
                          <div key={`${item.name}-${index}`} className="rounded border border-secondary px-2 py-2 text-xs text-white">
                ...
                <div className="text-center fs-8 text-muted">
        ...
        <div className="position-fixed top-0 bottom-0 start-0 end-0 bg-dark bg-opacity-75 d-flex align-items-center justify-content-center p-3" style={{ zIndex: 1050 }}>
          <div className="gold-panel w-100" style={{ maxWidth: 400 }}>
            <div className="d-flex align-items-center justify-content-between mb-3 border-bottom pb-2" style={{ borderColor: 'rgba(212,175,55,0.2)' }}>
              ...
              <button onClick={() => setShowAddAddressModal(false)} className="btn btn-sm text-muted p-0">✕</button>
            </div>
            <form onSubmit={handleAddAddressSubmit} className="d-flex flex-column gap-2 fs-7">
              <div>
                <label className="text-muted mb-1 fs-8">Address Label</label>
              ...
              <div>
                <label className="text-muted mb-1 fs-8">Full Street Address *</label>
      ...
      {showQuickViewProduct && (
        <div className="position-fixed top-0 bottom-0 start-0 end-0 bg-dark bg-opacity-75 d-flex align-items-center justify-content-center p-3" style={{ zIndex: 1060 }}>
          <div className="gold-panel w-100" style={{ maxWidth: 720 }}>
            {/* Modal Topbar */}
            <div className="d-flex align-items-center justify-content-between mb-3 border-bottom pb-2" style={{ borderColor: "rgba(212,175,55,0.2)" }}>
              <div className="d-flex align-items-center gap-2">
                ...
                <span className="fs-8 text-muted">Product SKU: PRD-{showQuickViewProduct.id}</span>
              </div>
              <button onClick={() => setShowQuickViewProduct(null)} className="btn btn-sm text-muted p-0 border-0 bg-transparent fs-5">✕</button>
            </div>
            ...
            <div className="row g-4">
              ...
              <div className="col-12 col-md-5 d-flex flex-column gap-2">
                ...
                <div className="p-2 rounded-2 bg-dark border border-secondary text-center">
                  ...
                  <span className="fs-9 text-muted">Verified Customer Purchase Feedback</span>
                </div>
              </div>
              ...
              <div className="col-12 col-md-7 d-flex flex-column justify-between">
                <div>
                  <div className="d-flex align-items-center justify-content-between mb-1">
                    ...
                    <span className="fs-6 font-bold text-white">${showQuickViewProduct.price}</span>
                  </div>
                  <h3 className="fs-4 font-bold text-white mb-2">{showQuickViewProduct.name}</h3>
                  ...
                  <div className="p-3 rounded-3 mb-3" style={{ background: "#0e0d0b", border: "1px solid rgba(212,175,55,0.2)" }}>
                    ...
                    <div className="fs-9 text-muted font-mono text-truncate">
                  ...
                  {/* Product Description */}
                  <div className="mb-3">
                    <label className="fs-8 text-muted d-block mb-1">Item Description & Craftsmanship</label>
                    <p className="fs-8 text-white mb-0" style={{ lineHeight: 1.6 }}>
                  ...
                  <div className="row g-2 pt-2 border-top" style={{ borderColor: "rgba(212,175,55,0.15)" }}>
                    <div className="col-6">
                      <div className="fs-9 text-muted d-flex align-items-center gap-1">
